...
#   The getting value is: 1
mapping_index=`cat $G_CURRENTLOG/$input |grep "The getting value is" |awk -F: '{print $2}'|sed "s/ //g"`

echo "TMP_TR069_PORT_MAPPING_NUMBER_OF_ENTRIES=$mapping_index" > $G_CURRENTLOG/$output
