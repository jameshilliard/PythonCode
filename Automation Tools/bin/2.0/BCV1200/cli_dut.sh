...
basic.info(){
    echo "get bootloader basic info for BCV1200"
...
debug.info(){
    ...
    perl $U_PATH_TBIN/clicfg.pl -d $G_PROD_IP_BR0_0_0 -i 23 -m "^ >" -v "dumpcfg" -u $U_DUT_TELNET_USER -p $U_DUT_TELNET_PWD | tee -a $output
