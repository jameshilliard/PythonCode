...
special_node=(
    ...
    $U_TR069_WANDEVICE_INDEX.WANEthernetInterfaceConfig.MaxBitRatei
...
given_value_node=(
    ...
    "InternetGatewayDevice.WANDevice.x.WANConnectionDevice.x.WANIPConnectionNumberOfEntries=1"
    "InternetGatewayDevice.WANDevice.x.WANConnectionDevice.x.WANPPPConnectionNumberOfEntries=1"
    
    "InternetGatewayDevice.WANDevice.x.WANEthernetInterfaceConfig.MaxBitRate=100Mbps"
    #"InternetGatewayDevice.WANDevice.x.WANCommonInterfaceConfig.WANAccessType=DSL"
