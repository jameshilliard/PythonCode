...
-v G_CONFIG=1.0
-v G_TBTYPE=common
-v G_TST_TITLE="Advanced Configuration File"
...
-v U_TESTPATH=$SQAROOT/platform/1.0/verizon/testcases/acf/json
...
-tc $SQAROOT/platform/1.0/verizon/testcases/acf/tcases/config_file_save.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/acf/tcases/config_file_upload.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/acf/tcases/invalid_config_file_upload.xml
#------------------------------
# Checkout 
#------------------------------
-label finish
