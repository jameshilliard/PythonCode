...
-v G_CONFIG=1.0
-v G_TBTYPE=pf
-v G_TST_TITLE="Advanced MAC Cloning"
-v G_PROD_TYPE=MC524WR
-v G_HTTP_DIR=test/
-v G_FTP_DIR=/log/autotest	
-v G_TESTBED=tb_not_defined
-v G_FROMRCPT=sqa@actiontec.com
-v G_FTPUSR=root
...
-v U_TESTPATH=$SQAROOT/platform/1.0/verizon/testcases/amc/json
...
-tc $SQAROOT/platform/1.0/verizon/testcases/amc/tcases/tc_06013000001.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/amc/tcases/tc_06013000002.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/amc/tcases/tc_06013000003.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/amc/tcases/tc_06013000004.xml
#------------------------------
# Checkout 
#------------------------------
-label finish
