...
-v G_CONFIG=1.0
-v G_TBTYPE=ad
-v G_TST_TITLE="Advanced Diagnostics"
-v G_PROD_TYPE=MC524WR
-v G_HTTP_DIR=test/
-v G_FTP_DIR=/log/autotest	
-v G_TESTBED=tb_bhr2_hsu
-v G_FROMRCPT=hsu@actiontec.com
-v G_FTPUSR=root
...
-v U_TESTPATH=$SQAROOT/platform/1.0/verizon/testcases/ad/json
...
-tc $SQAROOT/platform/1.0/verizon/testcases/ad/tcases/tc_06010000001.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/ad/tcases/tc_06010000002.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/ad/tcases/tc_06010000001_nolanip.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/ad/tcases/tc_06010000002_nowanip.xml
#------------------------------
# Checkout 
#------------------------------
-label finish
