...
-v G_CONFIG=1.0
-v G_TBTYPE=arr
-v G_TST_TITLE="Advanced Reboot Router"
...
-v U_TESTPATH=$SQAROOT/platform/1.0/verizon/testcases/arr/json
...
-tc $SQAROOT/platform/1.0/verizon/testcases/arr/tcases/reboot_router.xml
#------------------------------
# Checkout 
#------------------------------
-label finish
