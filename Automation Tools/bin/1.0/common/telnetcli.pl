...
# Description:
#---------------- 
#   This script is used to telnet destination and run commands after login success
# Things To Do:
#--------------
#--------------------------------------------------------------------
use strict;
...
=head1 NAME
telnetcli.pl is used to access remote server and sequentially execute command after loggin the target then exit
...
Redirect stdout to the /path/sshcli.log,default is /tmp
