  ...
  def get_text
	...
	begin
    	...
    	begin
    	  ...
    	  puts 'Error : Did not reach WAN Ether page'
    	  return
    	end
	...
	begin
	  ...
	  puts 'Error : Did not WAN Ether Properties page'
	  return
	end
	...
	when 'mtu'
	    ret_mtu = @ff.text_field(:name, 'mtu').value()
	    if ret_mtu == @compare_str
		puts "PASS: The MTU size is #{ret_mtu}"
	    else
		puts "FAIL: The MTU size is #{ret_mtu}"
	    end
	else 
	...
	begin
    	...
    	begin
    	  ...
    	  puts 'Error : Did not reach WAN Coax page'
    	  return
    	end
	...
	begin
	  ...
	  puts 'Error : Did not WAN Coax Properties page'
	  return
	end
