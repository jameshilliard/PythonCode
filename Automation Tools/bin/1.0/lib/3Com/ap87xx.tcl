...
#
# $Id: ap87xx.tcl,v 1.2 2007/04/04 01:46:45 wpoxon Exp $
#

global Author Id RCSfile Revision Date Name

set cvs_author  [cvs_clean "$Author: wpoxon $"]
set cvs_ID      [cvs_clean "$Id: ap87xx.tcl,v 1.2 2007/04/04 01:46:45 wpoxon Exp $"]
set cvs_file    [cvs_clean "$RCSfile: ap87xx.tcl,v $"]
