#
# cisco-12xx.tcl - code for configuring the cisco 18xx family of access points.
#
...
#
# $Id: cisco-18xx.tcl,v 1.1 2006/08/16 15:34:45 manderson Exp $
#

global Author Id RCSfile Revision Date Name

set cvs_author  [cvs_clean "$Author: manderson $"]
set cvs_ID      [cvs_clean "$Id: cisco-18xx.tcl,v 1.1 2006/08/16 15:34:45 manderson Exp $"]
set cvs_file    [cvs_clean "$RCSfile: cisco-18xx.tcl,v $"]
set cvs_version [cvs_clean "$Revision: 1.1 $"]
set cvs_date    [cvs_clean "$Date: 2006/08/16 15:34:45 $"]
...
# a cisco-18xx AP from its parent class (the cisco-ios device family)
#
...
#
# entry point for configuring cisco-18xx
#
