...
JENKINS_URL = 'http://192.168.20.108:8080'
SKYPE_CHAT = '#test00886/$a9885cc1e372b390'
UPDATE_INTERVAL = 60  # seconds
MESSAGE_PREFIX = '[JenkinsBot] '
...
class BuildNotifier:
    ...
    def notify(self, build, event):
        message = event + ': ' + build.name + ' - ' + JENKINS_URL + '/job/' + urllib.quote(
