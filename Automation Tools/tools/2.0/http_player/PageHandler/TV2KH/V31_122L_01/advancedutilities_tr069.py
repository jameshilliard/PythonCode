    ...
    def replBody(self, body):
        ...
        for index, k in enumerate(fmt['keys']):
            ...
            if k == 'tr69cAcsUser':
                ...
                motiveClientVersion = os.getenv('U_CUSTOM_MOTIVE_CLIENT_VER', '3.0')
                if motiveClientVersion == '3.0':
                    if 'http://xatechdmw.xdev.motive.com/cwmpWeb/CPEMgt' == ACS_URL:
                        ...
                        if tr69cAcsPwd:
                            ...
                            body.updateValueByIndex(index, v)
                        continue
                elif motiveClientVersion == '4.0':
                    if 'http://iiothdmw13.iot.motive.com/cwmpWeb/CPEMgt' == ACS_URL:
                        tr69cAcsPwd = os.getenv('U_DEF_DUT_CWMP_CONN_ACS_PASSWORD')
                        if tr69cAcsPwd:
                            print 'update tr69cAcsPwd to ', tr69cAcsPwd
                            ev = tr69cAcsPwd
                            ...
                            body.updateValueByIndex(index, v)
                        continue
                    elif 'http://iiothdm13.iot.motive.com/cwmpWeb/CPEMgt' == ACS_URL:
                        tr69cAcsPwd = os.getenv('TMP_DUT_CWMP_CONN_ACS_PASSWORD')
                        if tr69cAcsPwd:
                            print 'update tr69cAcsPwd to ', tr69cAcsPwd
                            ev = tr69cAcsPwd
