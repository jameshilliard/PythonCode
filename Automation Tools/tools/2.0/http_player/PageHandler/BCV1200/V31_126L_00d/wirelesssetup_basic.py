...
class Page(PageBase):
    ...
    def replBody(self, body):
        ...
        for index, k in enumerate(fmt['keys']):
            ...
            #            wlRadiusServerIP_wl0v0    192.168.99.253
            #            wlRadiusPort_wl0v0    1812
            #            wlRadiusKey_wl0v0    1234567890
            #
            #            wlRadiusServerIP_wl0v1    192.168.99.253
            #            wlRadiusPort_wl0v1    1812
            #            wlRadiusKey_wl0v1    1234567890
            #
            #            wlRadiusServerIP_wl0v2    0.0.0.0
            #            wlRadiusPort_wl0v2    1812
            #            wlRadiusKey_wl0v2

            if k == 'wlRadiusServerIP_wl0v0' or k == 'wlRadiusServerIP_wl0v1' or k == 'wlRadiusServerIP_wl0v2':
                #idx_def_wep128 += 1
                if v != '0.0.0.0':
                    ev = os.getenv('U_WIRELESS_RADIUS_SERVER')
                else:
                    ev = v
                if ev:   v = ev
                body.updateValueByIndex(index, v)
            ...
            if k == 'wlRadiusKey_wl0v0' or k == 'wlRadiusKey_wl0v1' or k == 'wlRadiusKey_wl0v2':
                #idx_def_wep128 += 1
                if v != '':
                    ev = os.getenv('U_WIRELESS_RADIUS_KEY')
                else:
                    ev = v
                if ev:   v = ev
                body.updateValueByIndex(index, v)
