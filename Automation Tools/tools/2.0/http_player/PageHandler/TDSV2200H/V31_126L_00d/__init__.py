...
pages_handles = {
    ...
    'advancedsetup_lanipdhcpsettings.cgi': 'advancedsetup_lanipdhcpsettings',
    'dhcpdstaticlease.cmd': 'dhcpdstaticlease',
    'advancedsetup_lanipaddress_info.cgi': 'advancedsetup_lanipaddress_info',
    'advancedsetup_lanipaddress.cgi': 'advancedsetup_lanipaddress',
    #'serv_block.cmd' : 'serv_block',
    'scpmapp.cmd': 'scpmapp',
    'detail_access.tod': 'detail_access',
    'scdmz.cmd': 'scdmz',
    'advancedutilities_traceroute.cgi': 'advancedutilities_traceroute',
    'advancedutilities_tr069.cgi': 'advancedutilities_tr069',
}
...
class PageHandler():
    ...
    def __init__(self, player, loglevel=2):
        ...
        self.info('PageHandler for TV2KH 31.122L.01')
