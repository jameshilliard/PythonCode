...
class Page(PageBase):
    ...
    def replBody(self, body):
        ...
        if is_add == 'add':
            ...
            #		username	aa:bb:cc:dd:ee:ff_12760120
            #		days	127
            #		start_time	60
            #		end_time	120
            #		needthankyou	advancedsetup_schedulingaccess.html
            ...
            for index, k in enumerate(fmt['keys']):
                ...
                if k == 'mac':
                    ...
                    ev = lan_mac.lower() + '_' + days + start_time + end_time
                    if ev:
                        v = ev
                        print '== change %s to %s' % (k, v)
                    body.updateValueByIndex(index, v)
            ...
            #		action	remove
            #		rmLst	aa:bb:cc:dd:ee:ff_12760120
            #		needthankyou	advancedsetup_schedulingaccess.html
