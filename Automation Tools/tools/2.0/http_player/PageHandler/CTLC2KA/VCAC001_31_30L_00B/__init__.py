...
pages_handles = {
    ...
    'wirelesssetup_radiosetup.wl': 'wirelesssetup_radiosetup',
    'scvrtsrv.cmd': 'scvrtsrv',
    'wansetup.cmd': 'wansetup',
    'dslatm.cmd': 'dslatm',
    'dslptm.cmd': 'dslptm',
    'tr69.cgi': 'tr69',
    'utilities_timezone.cgi': 'utilities_timezone',
    'advancedsetup_dhcpsettings.cgi': 'advancedsetup_dhcpsettings',
    'advancedsetup_lanipaddress.cgi': 'advancedsetup_lanipaddress',
    'urlfilter.cmd': 'urlfilter',
    #'serBlock.cmd' : 'serBlock',
    'scpmapp.cmd': 'scpmapp',
    'detail_access.tod': 'detail_access',
    'scdmz.cmd': 'scdmz',
    'ipv6_traceroute.cgi': 'ipv6_traceroute',
    'advancedsetup_remotegui.cgi': 'advancedsetup_remotegui',
    'advancedsetup_remotetelnet.cgi': 'advancedsetup_remotetelnet',
    'dhcpdstaticlease.cmd': 'dhcpdstaticlease',
    'ethwan.cmd': 'ethwan',
}
...
class PageHandler():
    ...
    def __init__(self, player, loglevel=2):
        ...
        self.info('PageHandler for C1KA CAC001-31.30L.00B')
