...
body_fmts[
    "editWanL2IfName"] = 'action=edit&editWanL2IfName=ptm0&ptmportId=0&ptmPriorityNorm=1&ptmPriorityHigh=0&enblQos=1&connMode=1&vdsl_trspt_mode=manual&modulationType=ADSL_Modulation_All&mainvlanMuxId=-1&mainvlanMuxPr=3&ptmmtu=1492&wanIfName=ppp0.1&autoselect=auto&manualselect=auto&do_manual_under_automode=yes&redirect=advancedsetup_broadbandsettings.html&sessionKey=1630337537&needthankyou=advancedsetup_broadbandsettings.html'
