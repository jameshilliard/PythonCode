...
body_fmts[
    "wep_active="] = 'apply_page=wireless_advanced_wep.html%3Fssid%3Dath0&waiting_page=waiting_page.html&waiting_page_leftmenu=3&waiting_page_topmenu=1&wireless_vap_name=ath0&wep_mode=0&radius_server_ip=0.0.0.0&radius_server_port=1812&radius_shared_secret=&wep_auth=0&wep_active=1&wep_key_0_code=0987654321&wep_key_0_mode=0&wep_key_0_len=0&wep_key_1_code=&wep_key_1_mode=0&wep_key_1_len=0&wep_key_2_code=&wep_key_2_mode=0&wep_key_2_len=0&wep_key_3_code=&wep_key_3_mode=0&wep_key_3_len=0'
body_fmts[
    "wireless_security_enabled="] = 'apply_page=wireless_advanced_wpa.html%3Ftype%3DWPA%26ssid%3Dath0&waiting_page=waiting_page.html&waiting_page_leftmenu=3&waiting_page_topmenu=1&wireless_security_enabled=WPA&wireless_vap_name=ath0&wpa_sta_auth_type=0&wpa_pre_authentication=0&wpa_sta_auth_shared_key_radio=1&wpa_sta_auth_shared_key=&wpa_psk_representation=0&wpa_cipher=1&wpa_is_grp_key_update=0&wpa_grp_key_update_interval=0&radius_server_ip=0.0.0.0&radius_server_port=1812&radius_shared_secret='
#-----------------------------------------------------------------------
query_fmts = {}
    ...
    def replBody(self, body):
        ...
        if body.value('wireless_security_enabled') and body.value('wireless_security_enabled') == 'WPA2':
            ...
            if psk:
                body.updateValue('wpa_sta_auth_shared_key', psk)
            # WPA+WPA2
        if body.value('wireless_security_enabled') and body.value('wireless_security_enabled') == 'WPA+WPA2':
            #logger.debug('here')
            psk = os.getenv('U_WIRELESS_CUSTOM_WPAPSK')
            if psk:
                body.updateValue('wpa_sta_auth_shared_key', psk)
