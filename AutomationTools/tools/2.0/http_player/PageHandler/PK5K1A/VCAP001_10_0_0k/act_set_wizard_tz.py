...
class Page(PageBase):
    ...
    def replBody(self, body):
        ...
        """
        #	Lantiq
        #	/goform/act_set_wizard_tz
        #
        #	page	utilities_timezone.html                 page	utilities_timezone.html
        #	NTP_Client	1                                   NTP_Client	1
        #	NTP_Server_List	ntp.actiontec.com               NTP_Server_List	ntp.actiontec.com
        #	NTP_Secondary_Server_List	ntp1.tummy.com      NTP_Secondary_Server_List	ntp1.tummy.com
        #	tz	Mountain Time                               tz	Eastern Time
