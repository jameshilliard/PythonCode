...
pages_handles = {
    ...
    'page_conn_settings_eth1': 'conn_settings_eth1',
    'page_actiontec_wireless_setup_mac': 'wireless_setup_mac',
    'page_fw_port_forwarding': 'fw_port_forwarding',
    'page_fw_general': 'fw_general',
    'page_fw_dmz_host': 'fw_dmz_host',
    'page_remote_admin_fw': 'remote_admin_fw',
    'page_time_settings': 'time_settings',
    'page_conn_settings_br0': 'lan_dhcp_set',
    'DHCP+Connection+Settings': 'dhcp_reservation_add',
    'DHCP+Connections': 'remove_dhcp_reservation',
    #'Add+Advanced+Filter':'ServiceBlocking_add_rule',
    'Edit+Item': 'ServiceBlocking_add_rule',
    #'Edit+Network+Object':'ServiceBlocking_add_rule',
    'page_wf_policy': 'wf_policy',
    #    Rule Summary
    'Rule+Summary': 'wf_policy',
}
