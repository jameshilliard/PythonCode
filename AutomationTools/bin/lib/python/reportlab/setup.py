...
__version__=''' $Id: setup.py,v 1.3 2006/05/03 20:42:40 wpoxon Exp $ '''
...
if os.environ.has_key('VW_INSTALL_ROOT'):
  package_path = pjoin(os.environ['VW_INSTALL_ROOT'], 'lib', 'python', 'reportlab')
elif os.environ.has_key('VW_TEST_ROOT'):
  package_path = pjoin(os.environ['VW_TEST_ROOT'], 'lib', 'python', 'reportlab')
else:
