...
bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom64_1 -v $U_WIRELESS_CUSTOM_WEP_KEY64bit1 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*"; 
bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom64_2 -v $U_WIRELESS_CUSTOM_WEP_KEY64bit2 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*"; 
bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom64_3 -v $U_WIRELESS_CUSTOM_WEP_KEY64bit3 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*"; 
bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom64_4 -v $U_WIRELESS_CUSTOM_WEP_KEY64bit4 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*";

bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom128_1 -v $U_WIRELESS_CUSTOM_WEP_KEY128bit1 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*"; 
bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom128_2 -v $U_WIRELESS_CUSTOM_WEP_KEY128bit2 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*"; 
bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom128_3 -v $U_WIRELESS_CUSTOM_WEP_KEY128bit3 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*"; 
bash  $U_PATH_TBIN/changeValueofRecord.sh -n wepcustom128_4 -v $U_WIRELESS_CUSTOM_WEP_KEY128bit4 -f "$U_PATH_SANITYWICFG/B-$U_DUT_TYPE-WI*";
