...
-v G_CONFIG=1.0
-v G_TBTYPE=ard
-v G_TST_TITLE="Advanced Restore Defaults"
...
-v U_TESTPATH=$SQAROOT/platform/1.0/verizon/testcases/ard/json
...
-tc $SQAROOT/platform/1.0/verizon/testcases/ard/tcases/restore_default_save.xml
-tc $SQAROOT/platform/1.0/verizon/testcases/ard/tcases/restore_default.xml
#------------------------------
# Checkout 
#------------------------------
-label finish
