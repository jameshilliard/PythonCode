 ...
 *  Tel: 86-021-58206778
 * **************************************************************************************
 * File Name	: modify_account.php,v $
 * Description	: The file is used to modify user infomation.
 *
...
function account($_user_id,$_passwd,$_group,$_email,$_description)
{
	...
	if(!$res){ 
		...
		//echo '<center><table border="0" cellspacing="0" cellpadding="0" width=60% height=400>
        	//  	<tr><td align="center"><font color=green size=12><a href=manage_users.php>Hi '.$_user_id.',you have updated successfully!                                    </a></font></td></tr></table></center>';
...
if($_GET['action']=="modify"){
	...
	echo '<center> <form method=post action=modify_account.php?action=update&user_id='.$row_value[0].'>
	<table width=50%>
		<tr>
...
function displayerror($errs,$_user_id,$_passwd,$_email,$_group,$_description)
{
	...
	echo '<center> <form method=post action=modify_account.php?action=update&user_id='. $_user_id .'>
	<table width=50%>
		<tr>
			<td width=30% align=right>UserID:</td>
