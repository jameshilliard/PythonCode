...
#
set wauto_version "Dev-version-xx"
# wauto_version to be substituded by the make build with actual string
set release_version 4.2-WT-3.5_2009.02.19.03
...
#
#    --db                      - Enable DataBase support.
#                                Overrides configuration file setting.
#                                
#
#    --pf                      - Enable User Specified PassFail criteria.
#                                Overrides configuration file setting.
#                                
#
###################################################################
...
#   keylset global_config PassFailUser $PassFailUser
   ...
   set scriptpath [file join $VW_TEST_ROOT  bin temp_tc.txt ]

   set TestCaseName [file tail $args(-f)]
   set TestCaseName [file rootname $TestCaseName]
   set filep [open "$scriptpath" "w"]
