#
# ap-5131.tcl - configures a Symbol ap-[13]00 access point (device-under-test)
#
...
#
# $Id: ap-xxx.tcl,v 1.3 2007/04/04 01:46:46 wpoxon Exp $
#

global Author Id RCSfile Revision Date Name

set cvs_author  [cvs_clean "$Author: wpoxon $"]
set cvs_ID      [cvs_clean "$Id: ap-xxx.tcl,v 1.3 2007/04/04 01:46:46 wpoxon Exp $"]
set cvs_file    [cvs_clean "$RCSfile: ap-xxx.tcl,v $"]
...
# will get utilized for configuring any settings unique to the ap-300 or ap-100

# symbol doesn't really have device families, so we just inherit
# at the vendor level.
set lib [file join $::VW_TEST_ROOT lib symbol symbol-thin.tcl]
...
#
# entry point for configurating the ap
#
set ::config_file_proc dut_configure_symbol
