...
perl $U_COMMONBIN/clicfg.pl  -l $G_CURRENTLOG -d $G_PROD_IP_ETH0_0_0 -i 23 -u $U_DUT_TELNET_USER -p $U_DUT_TELNET_PWD -m ">" -v "route show" -v "wan show" -v "ifconfig" | tee $G_CURRENTLOG/dut_info.log
...
# save result to file
echo "U_DUT_WAN_IF=$dut_wan_if U_DUT_WAN_IP=$dut_wan_ip U_DUT_DEF_GW=$dut_def_gw" > $rcfile
exit 0
