...
Test Teardown     TR_Disable_WiFi_5G_MAC_Authentication
...
Wireless STA is in Deny List (Drop-Down List)
    ...
    TR_GPV_Check    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Enabled =1 boolean    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Deny_Policy =1    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_MACList =%{U_WIRELESS_CARD_MAC}
...
Wireless STA is in Allow List (Drop-Down List)
    ...
    TR_GPV_Check    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Enabled =1 boolean    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Deny_Policy =0    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_MACList =%{U_WIRELESS_CARD_MAC}
...
Wireless STA is NOT in Deny List
    ...
    TR_GPV_Check    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Enabled =1 boolean    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Deny_Policy =1    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_MACList =11:22:33:44:55:66
    #[Step 2][Fun Check]    The attempt to associate with the SSID must be rejected and the Wireless STA is unable to associate with DUT
    #ConnectSSID    ssid=%{U_CUSTOM_SSID}    key=%{U_WIRELESS_CUSTOM_WPAPSK}    bssid=%{U_WIRELESS_2G_BSSID1}
    #End Test
...
Wireless STA is NOT in Allow List
    ...
    TR_GPV_Check    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Enabled =1 boolean    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_Deny_Policy =0    Device.WiFi.AccessPoint.5.ACL.X_ACTIONTEC_COM_ACL_MACList =11:22:33:44:55:66
    #[Step 2][Fun Check]    The attempt to associate with the SSID must be rejected and the Wireless STA is unable to associate with DUT
