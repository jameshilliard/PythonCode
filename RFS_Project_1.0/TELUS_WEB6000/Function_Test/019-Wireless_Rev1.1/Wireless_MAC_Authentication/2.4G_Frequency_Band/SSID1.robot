...
Wireless STA is in Deny List (Drop-Down List)
    ...
    TR_SPV    Device.WiFi.AccessPoint.1.ACL.X_ACTIONTEC_COM_ACL_Enabled =1 boolean
    …    Device.WiFi.AccessPoint.1.ACL.X_ACTIONTEC_COM_ACL_Deny_Policy =1 boolean
    …    Device.WiFi.AccessPoint.1.ACL.X_ACTIONTEC_COM_ACL_MACList =${U_WIRELESS_CARD_MAC} string
    TR_GPV_Check    Device.WiFi.AccessPoint.1.ACL.X_ACTIONTEC_COM_ACL_Enabled =1
    ...    Device.WiFi.AccessPoint.1.ACL.X_ACTIONTEC_COM_ACL_Deny_Policy =1
    ...    Device.WiFi.AccessPoint.1.ACL.X_ACTIONTEC_COM_ACL_MACList =${U_WIRELESS_CARD_MAC}
