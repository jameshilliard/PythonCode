...
02301654_Wireless Reset on Broadband Gateway
    ...
    TR_GPV_Check    Device.WiFi.AccessPoint.1.Security.ModeEnabled=WPA-WPA2-Personal
    ...    Device.WiFi.AccessPoint.1.Security.X_ACTIONTEC_COM_WPAEncryptionMode=AESEncryption
    ...    Device.WiFi.SSID.1.SSID=${U_WIRELESS_SSID1}
    …    Device.WiFi.AccessPoint.5.Security.ModeEnabled=WPA-WPA2-Personal
    ...    Device.WiFi.AccessPoint.5.Security.X_ACTIONTEC_COM_WPAEncryptionMode=AESEncryption
    ...    Device.WiFi.SSID.5.SSID=${U_WIRELESS_SSID1}
